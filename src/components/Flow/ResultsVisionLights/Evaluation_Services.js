 ...
 <input type="submit" value="Submit" />
      ...
      {(() => {
        switch (this.state.value) {
          ...
          <div class="polaroid-right"><a href="/services"><img src={car} width="430" height="280" style={{float: 'right'}} /></a><h3>Find services that could help you repair your car</h3> </div>
